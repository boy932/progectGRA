...
class SellFoodScreen extends StatefulWidget {

  @override
  State<SellFoodScreen> createState() => _SellFoodScreenState();
}

class _SellFoodScreenState extends State<SellFoodScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text('SELL FOOD',style: textLargStyle.copyWith(color: Colors.black87,fontSize: 26),),
                        ],
                      ),
                    ),
                    SizedBox(height: 5,),
                    ...
                    Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(' Price:',style: textSmallStyle.copyWith(color: Colors.grey[400]!,fontSize: 18,fontWeight: FontWeight.w600),),
                          CustomInput( keyboardType: TextInputType.text,controller: expiratoinDateCon,),
                        ],
                      ),
                    ),
                    ...
                    RaisedButton(
                      ...
                      color: PRIMARY_COLOR,
                      child:Center(
                        child: Text('Add',style: textSmallStyle.copyWith(fontSize: 18),),
                      ),
                    )
